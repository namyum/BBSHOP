            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary" style='display:block;'>
                  ...
                  <p class="card-category">관리자 계정을 볼수있습니다.</p>
                ...
                <div class="card-body">
                  ...
                  <table id='categoryList'>
							<tr>
								<td><label for="category">관리자 계정 분류</label> &nbsp; &nbsp;</td>
								<td><input type='checkbox' id='admin_all' name='admin_category'>전체 &nbsp;&nbsp;&nbsp;</td>
								<td><input type='checkbox' id='admin_shop' name='admin_category'>쇼핑몰 관리자&nbsp;&nbsp;&nbsp;</td>
								<td><input type='checkbox' id='admin_community' name='admin_category'>커뮤니티 관리자&nbsp;&nbsp;&nbsp;</td>
								<td><input type='submit' id='admin_submit' name='admin_category_submit' value='조회' class='btn btn-info'></td>
                  ...
                  <div class="table-responsive">
                      ...
                      <tbody>
                      	<tr>
                     		...
                     		<td style='text-align:center'><input type='checkbox' id='check_admin'></td>
                      		<td style='text-align:center'>Admin</td>
                      		<td style='text-align:center'>1234</td>
                      		<td style='text-align:center'>CM_LG</td>
                      		<td style='text-align:center'>커뮤니티관리자</td>
                      		<td style='text-align:center'><button class='btn btn-info btn-sm'>수정</button></td>
                      		<td style='text-align:center'><button id="deleteAccount" class="btn btn-danger btn-sm">삭제</button>
                      	</tr>
  ...
  <script>
    ...
    $(document).ready(function() {    	
      ...
      $().ready(function() {
    	  ...
    	  $(".sidebar-wrapper li").eq(8).addClass('active');
