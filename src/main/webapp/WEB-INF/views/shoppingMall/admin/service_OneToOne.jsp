                  ...
                  <table id='categoryList'>
						<form>
							<tr>
								...
								<td><input type='checkbox' id='FAQ_change_cancel' name='FAQ_category'>카테1 &nbsp;&nbsp;&nbsp;</td>
								<td><input type='checkbox' id='FAQ_all' name='FAQ_category'>카테2&nbsp;&nbsp;&nbsp;</td>
								<td><input type='checkbox' id='FAQ_all' name='FAQ_category'>카테3&nbsp;&nbsp;&nbsp;</td>
                  ...
                  <div class="table-responsive">
                      ...
                      <tbody>
                      	<tr>
                      		...
                      		<td style='text-align:center'>카테1</td>
                      		<td style='text-align:center'><Button id="info_FAQ" type="button" class="btn btn-link" align=center>카테1 관련해서 문의있습니다. 불라불라랄라블라</Button></td>
                      		<td style='text-align:center'>오프화이트 블레이저 og</td>
                      		<td style='text-align:center'>19.07.10</td>
                      		<td style='text-align:center'>O</td>
                      		<td style='text-align:center'><input type='button' id='goanswer' class='btn btn-info btn-sm' value='답변'></td>
                      	</tr>
                      	<tr>
                      		
                      		<td style='text-align:center'>0000002</td>
                      		<td style='text-align:center'>카테2</td>
                      		<td style='text-align:center'><Button id="info_FAQ" type="button" class="btn btn-link" align=center>카테2 관련해서 문의있습니다. 으아으아불라불라브바브바 </Button></td>
                      		<td style='text-align:center'>사카이와플</td>
                      		<td style='text-align:center'>19.07.11</td>
                      		<td style='text-align:center'>X</td>
                      		<td style='text-align:center'><input type='button' id='goanswer' class='btn btn-info btn-sm' value='답변'></td>
                      	</tr><tr>
                      		
                      		<td style='text-align:center'>0000003</td>
                      		<td style='text-align:center'>카테3</td>
                      		<td style='text-align:center'><Button id="info_FAQ" type="button" class="btn btn-link" align=center>카테3 관련해서 문의있습니다. 루키루키 난수퍼루키루키루키</Button></td>
                      		<td style='text-align:center'>조던루키</td>
                      		<td style='text-align:center'>19.07.10</td>
                      		<td style='text-align:center'>X</td>
                      		<td style='text-align:center'><input type='button' id='goanswer' class='btn btn-info btn-sm' value='답변'></td>
                      	</tr><tr>
                      		...
                      		<td style='text-align:center'>카테1</td>
                      		<td style='text-align:center'><Button id="info_FAQ" type="button" class="btn btn-link" align=center>카테1 관련해서 문의있습니다. 랄라블라~</Button></td>
                      		<td style='text-align:center'>오프화이트 블레이저 og</td>
                      		<td style='text-align:center'>19.07.10</td>
                      		<td style='text-align:center'>X</td>
                      		<td style='text-align:center'><input type='button' id='goanswer' class='btn btn-info btn-sm' value='답변'></td>
