		...
		<div class="row">
			<div class="col-lg-12">
				<blockquote class="generic-blockquote">
					<p>탈퇴하기를 누르시면 1주일 간 계정이 휴면 상태로 전환됩니다. 1주일이 지나면 자동 삭제되고, 그 사이에 계정을 정상 복원할 수 있습니다.</p>
					<p>저희 쇼핑몰의 부족했던 점과
				...
				<a href="/secede.do" class="genric-btn default radius" onclick="alert('계정이 휴면 처리되었습니다. 1주일 뒤 자동 삭제됩니다.');" style="margin-right: 30px;"><span>탈퇴하기</span>
						</a>
